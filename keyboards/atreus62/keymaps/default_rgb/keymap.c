...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT(
    ...
    KC_TRNS,      RGB_TOG, 	        RGB_HUI, RGB_MODE_FORWARD, RGB_SAI, RGB_VAI,                     KC_F12,  KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS ,
    TO(_RESET),   RGB_MODE_PLAIN,   RGB_HUD, RGB_MODE_REVERSE, RGB_SAD, RGB_VAD,                     KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS ,
    KC_TRNS,      RGB_MODE_BREATHE, RGB_MODE_RAINBOW, RGB_MODE_SWIRL, RGB_MODE_SNAKE, RGB_MODE_KNIGHT,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS ,
